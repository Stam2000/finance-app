            ...
            let width=0
                ...
                return(
                    ...
                    <div className="flex w-full justify-between items-center mb-2">
                        ...
                        <div className="flex w-full justify-end gap-1  items-center">
                            ...
                            <div className="flex items-center justify-center gap-1">
                                <p className="text-md font-nunito text-slate-900">remaining:</p>
                                <p className="text-sm text-green-800  font-bold">{formatCurrency(convertAmountFromMiliunits(c.amount))}</p>
                            </div>
                    ...
                    <div className="flex items-center justify-around space-x-1">
                                <div className="flex items-center justify-center gap-1">
                                    <p className="text-md font-nunito text-gray-900">spent:</p>
                                    <p className="text-sm text-red-800   font-bold">{formatCurrency(convertAmountFromMiliunits(c.amount))}</p>
                                </div>
                    ...
                    <div className="flex items-center space-x-1">
                            <div className="flex items-center justify-center gap-1">
                                <p className="text-md font-nunito text-gray-900">limit:</p>
                                <p className="text-sm text-yellow-600  font-bold">{formatCurrency(convertAmountFromMiliunits(c.goal!))}</p>
                                </div>
                            </div>
