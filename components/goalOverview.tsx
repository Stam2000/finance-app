            ...
            const percentage = c.percentage
                ...
                return(
                    ...
                    <div className="flex w-full justify-between items-center mb-2">
                        <h2 className="text-[12px]  md:text-sm px-2 font-nunito font-bold  flex gap-1 items-center  justify-center  text-slate-800"><img className="object-cover rounded-xl h-4 "  src={`/tag-horizontal-svgrepo-com.svg`}  alt={"lg.displayName"}/> {c.name}</h2>
                        <div className="flex  justify-end gap-1  items-center">
                            <div className="flex items-center  space-x-1">
                            <div className="flex items-center justify-center gap-1">
                                <p className="text-[12px] md:text-sm font-nunito text-slate-900">remaining:</p>
                                <p className="text-[12px] md:text-sm text-green-800 ">{formatCurrency(convertAmountFromMiliunits(c.amount))}</p>
                            </div>
                    ...
                    <div className="flex items-center justify-around space-x-1">
                                <div className="flex items-center justify-center gap-1">
                                    <p className="text-[12px] md:text-sm font-nunito text-gray-900">spent:</p>
                                    <p className=" text-[12px] md:text-sm text-red-800 ">{formatCurrency(convertAmountFromMiliunits(c.amount))}</p>
                                </div>
                    ...
                    <div className="flex items-center space-x-1">
                            <div className="flex items-center justify-center gap-1">
                                <p className="text-[12px] md:text-sm font-nunito text-gray-900">limit:</p>
                                <p className="text-[12px] md:text-sm text-yellow-600">{formatCurrency(convertAmountFromMiliunits(c.goal!))}</p>
                                </div>
                            </div>
