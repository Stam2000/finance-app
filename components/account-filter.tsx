...
import Select, { components, DropdownIndicatorProps, ClearIndicatorProps } from 'react-select'
...
export const AccountFilter = () => {
    ...
    const customStyles = {
        control: (provided, state) => ({
          ...
          backgroundColor: state.isFocused ? 'rgba(255, 255, 255, 0.3)' : 'rgba(255, 255, 255, 0.1)', // Matches `bg-white/10` and `focus:bg-white/30`
