...
const profile = [
  ...
  },
  {
    ...
    description:
      "Isabella Rossi, a 38-year-old single Interior Designer in Milan, blends Italian elegance with modern creativity. Educated at Politecnico di Milano and Domus Academy, she excels in sustainable, high-profile projects. Fluent in Italian and English, Isabella travels frequently for work, values cultural experiences, and aspires to establish her own renowned design studio.",
    image: "isabella",
    fullDesc: persona2D,
  },
  {
  ...
  },
  {
    ...
    shoppingHabits: "impulsive",
    description:
      "Yumi Nakamura, a 30-year-old single chef in Tokyo, blends traditional Japanese values with modern innovation. Educated at Tsuji Culinary Institute, she excels in fusion cuisine and aims to open her own restaurant. Fluent in Japanese and English, Yumi values sustainability, creativity, and work-life balance while navigating Tokyo’s competitive culinary scene.",
    image: "yumi",
    fullDesc: persona4D,
  },
];
          ...
          <div className="flex items-center justify-around gap-1 mb-4">
            ...
            <div className="flex flex-1 flex-col items-center justify-center ">
              ...
              <div className="flex items-center justify-center">
                ...
                >
                  Go to Dashboard <MoveRight className="ml-2" size={16} />{" "}
                </Button>
              </div>
              <div className="text-slate-600 md:-mb-2 italic ">gen with Ai</div>
            </div>
          </div>
          <div>
            <div className="mb-4">
              <div className="w-full grid gap-3 grid-cols-2 rounded-md  bg-gradient-to-r from-black  to-slate-950 to-90% p-3  text-sm">
                <div className=" flex-col flex items-center justify-center ">
                  <span className="font-bold text-sm flex  items-center text-white  gap-1">
                    {" "}
                    Nationality 📘:
                  </span>{" "}
        ...
        <div className="flex gap-5 lg:gap-1 items-start justify-center ">
          <div className="w-2/5 flex flex-col gap-4  items-center justify-between h-[50%]">
            ...
            <div className="flex items-center justify-center">
              <Button
                disabled={isDisabled}
                className="bg-black   md:text-[12px] "
                onClick={() => handleClick(persona)}
              >
                Go to Dashboard <MoveRight className="ml-2" size={16} />{" "}
              </Button>
            ...
            <div>
              <div className="w-full grid  lg:grid-cols-4 rounded-md  bg-gradient-to-r from-black  to-slate-950 to-90% p-2 gap-2 text-md">
                <div className=" flex-col flex items-center  ">
                  <span className="font-bold md:text-sm lg:text-md flex  items-center text-white  gap-1">
                    {" "}
                    Nationality 📘:
                  </span>{" "}
                  <span className="text-gray-200 md:text-sm lg:text-md flex items-center justify-center h-full ">
                    {persona.nationality}
                  </span>
                </div>
                <div className="flex-col flex items-center">
                  <span className="font-bold  md:text-sm lg:text-md flex items-center justify-self-start  text-white gap-1">
                    {" "}
                    Location 🗺️:
                  </span>{" "}
                  <span className="text-gray-200 md:text-sm lg:text-md flex items-center justify-center h-full ">
                ...
                <div className="flex-col flex items-center ">
                  ...
                  <span className="text-gray-200 md:text-sm lg:text-md text-center flex items-center justify-center h-full ">
                    {persona.occupation}
                  </span>
                </div>
                <div className="flex-col flex items-center ">
        ...
        {openForm ? (
          ...
          >
            ...
            <motion.div variants={childrenVariants} className=" h-[90%] mb-3">
              <PersonaForm
                onDisable={() => setIsDisabled((prev) => !prev)}
            ...
            {generatedData && (
              <motion.div
                ...
                className="bg-slate-50 mx-6 border-[1px] w-full text-md border-slate-500 h-full rounded-md font-light overflow-y-auto"
              >
                <MarkdownTypewriter
          ...
          <motion.div
            key={"list"}
            initial={isFirstRender.current ? "firstLoad" : "hidden"}
            variants={parentVariantLeft}
            animate={isFirstRender.current ? "firstVisible" : "visible"}
            className="w-full h-full p-10 flex flex-col gap-4 "
          >
            <div>
              <img
                className="object-cover rounded-xl h-10 "
                src={`/logo.png`}
                alt={"logo.png"}
              />
            </div>
            <div className="">
              <div className="text-sm  mt-4">
                <p className="mb-3">
                  Selecting a ready-made profile to experience how FImae can
                  support your financial decisions.
                </p>
                <p className="mb-3 text-center">or</p>
                <p className="mb-2">
                  Creating a custom profile tailored to your needs or use AI to
              ...
              <div className="flex items-center justify-center my-6">
                <button
                  onClick={() => setOpenForm((prev) => !prev)}
                  className=" w-full border-2 border-slate-500 text-slate-950 text-md rounded-lg p-2"
                >
                  <div className="flex flex-col">
                    <span className="font-bold text-sm">Custom Profile</span>
            ...
            <motion.div variants={childrenLeft} className=" scrollbar-none">
              {profile.map((p, index) => (
                <CardDisplay isDisabled={isDisabled} key={index} persona={p} />
              ))}
            </motion.div>
          </motion.div>
        )}
      ...
      >
        <div className="">
          <div className="flex items-center mt-2 lg:mt-4 gap-2 ">
            ...
            {generatedData === "" && (
              <p className="flex-1 leading-[30px] 2xl:leading-[35px] p-2 2xl:p-4 rounded-xl text-center font-poiret-one  md:text-[28px] 2xl:text-[38px] font-bold  bg-gradient-to-r from-slate-800 from-0% via-blue-700 via-25% to-blue-950 to-100% text-transparent bg-clip-text">
                {" "}
                Welcome to{" "}
                <span className="desk:underline decoration-blue-800 underline-offset-8 decoration-4">
                  Fimae
                </span>
          ...
          {generatedData === "" && (
            <div className=" flex flex-col 2xl:py-4">
              <p className="self-center  text-slate-800 font-caveat md:text-2xl  desk:text-4xl ">
                {" "}
                two ways to start:
              </p>
              <p className="flex gap-2 lg:mt-4 lg:mb-8">
                <span className="flex-1 md:text-sm 2xl:text-[17px] text-slate-600 text-center  font-oxygen ">
                  Selecting a ready-made profile to experience how FImae can
                  support your financial decisions.
                </span>
                <span className=" w-14 flex items-center font-caveat text-slate-500 text-2xl justify-center">
                  or
                </span>
                <span className="flex-1 md:text-sm 2xl:text-[17px] text-center font-oxygen text-slate-600 ">
                  Creating a custom profile tailored to your needs or use AI to
                  generate a profile for you
                </span>
              </p>
        ...
        {generatedData ? (
          <div className="overflow-y-auto flex-1 scrollbar-none ">
            <motion.div
              key={"MarkdownTypewriter"}
              transition={{
                x: { type: "spring", stiffness: 350, damping: 40 },
              }}
              initial={{ x: -1000 }}
              animate={{ x: 0 }}
              className="bg-slate-50 border-[1px] border-slate-500 h-full rounded-md font-light overflow-y-auto"
            >
              <MarkdownTypewriter
                content={generatedData}
                typeSpeed={30}
