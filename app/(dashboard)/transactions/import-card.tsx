...
export const ImportCard = ({
    ...
    if(categoriesQuery!=undefined) {setCategories(categoriesQuery.data)}
    },[]) */
    
    const categoriesQuery = useGetCategories()
    const categoryMutation = useCreateCategory()
    const categories = categoriesQuery.data /* [{id:string; name:string},{id:string; name:string},...] */
            ...
            if(!category){
                if(!localCache[CategoryName]){
                    ...
                    name:CategoryName
                        ...
                        setCategoryCache((prevCache) => ({ ...prevCache, [CategoryName]:category!.id }));
        ...
        <div className="w-full max-w-screen-2xl mx-auto pb-10 -mt-24" >
            ...
            <CardHeader className="gap-y-2 lg:flex-row lg:items-center lg:justify-between" >
                ...
                <div className="flex flex-col gap-y-2 itens-center gap-x-2 lg:flex-row" >
                    ...
                    >Continue ({progress} / {requiredOptions.length}) </Button>
                </div>
            </CardHeader>
            <CardContent>
              <ImportTable 
