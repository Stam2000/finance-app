...
import { formatInstExtenderGen, promptDetails, promptFundamentalWeek, promptRefine } from "@/lib/AI/prompts"
...
for (let week = 0; week < 4; week++){
  ...
  controller.enqueue(createSSEMessage('weekGen', {
    step: `weekGen-${week+1}`,
    status: "running",
...
console.log(`
  ...
  attempts++
        ...
        controller.enqueue(createSSEMessage('updatingFiDataStart', {
          ...
          const d =  await uploadEntitiesAndReplaceReferences(transactions,personaId)
